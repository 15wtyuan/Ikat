...
namespace Ikat.HeadlessTests
{
    ...
    public unsafe class AcceptanceGateTests
    {
        ...
        // ═════════════════════════════════════════════════════════════════
        // Criterion 8: Events — Clicked += → feed Click IkatEvent → Pump → fires + Target correct.
        // ═════════════════════════════════════════════════════════════════
        ...
        // Parent Style.IkatColor = red → Tick → child computed color = red
        ...
        public void Criterion9_InlineInheritance()
        {
            ...
            try
            {
                ...
                // Set parent Style.IkatColor to blue (0,0,1,1) via inline override.
                // This must override the CSS class .highlight{color:red} on root
                // and propagate to child via cascade inheritance.
                instRoot.Style.TextColor = new IkatColor(0, 0, 1, 1);
                Tick(h, ctx);
