    ...
    public unsafe class FixtureSmokeTests
    {
        ...
        public void FixtureLoadsAndInstantiatesAll9Criteria()
        {
            ...
            try
            {
                ...
                byte rootKind = 0xFF;
                Assert.Equal(0, Native.yio_stage_get_node_kind(h, instRoot._id, &rootKind));
                ...
                byte childKind = 0xFF;
                Assert.Equal(0, Native.yio_stage_get_node_kind(h, child._id, &childKind));
                ...
                byte textKind = 0xFF;
                Assert.Equal(0, Native.yio_stage_get_node_kind(h, text._id, &textKind));
                ...
                byte btnKind = 0xFF;
                Assert.Equal(0, Native.yio_stage_get_node_kind(h, btn._id, &btnKind));
                ...
                byte imgKind = 0xFF;
                Assert.Equal(0, Native.yio_stage_get_node_kind(h, img._id, &imgKind));
                ...
                YioRect lr = instRoot.Geometry.LayoutRect;
                ...
                // Dispose instRoot → children cascade-disposed.
                {
                    ...
                    byte deadKind = 0xFF;
                    Assert.NotEqual(0, Native.yio_stage_get_node_kind(h, childIdLc, &deadKind));
                }
