...
namespace Yio.HeadlessTests
{
    public class CssValueConvertTests
    {
        ...
        // ── YioColor ────────────────────────────────────────────────────
        [Fact]
        public void ColorHexRedOpaque() => Assert.Equal("#ff0000ff", CssValueConvert.ToCss(new YioColor(1f, 0f, 0f, 1f)));

        [Fact]
        public void ColorHexWhiteHalfAlpha() => Assert.Equal("#ffffff80", CssValueConvert.ToCss(new YioColor(1f, 1f, 1f, 0.5f)));

        [Fact]
        public void ColorHexBlackTransparent() => Assert.Equal("#00000000", CssValueConvert.ToCss(new YioColor(0f, 0f, 0f, 0f)));

        [Fact]
        public void ColorUnsetIsNull() => Assert.Null(CssValueConvert.ToCss(YioColor.Unset));
        ...
        [Fact]
        public void ObjectDispatchColor() => Assert.Equal("#ff0000ff", CssValueConvert.ToCss((object)new YioColor(1f, 0f, 0f, 1f)));
