    ...
    public unsafe class NodeGeometryTransformTests
    {
        ...
        public void GeometryLayoutRectReadsFFI()
        {
            ...
            try
            {
                ...
                Tick(stage, ctx);
                YioRect lr = child.Geometry.LayoutRect;
        ...
        public void GeometryReturnsFreshSnapshot()
        {
            ...
            try
            {
                ...
                YioRect lr1 = child.Geometry.LayoutRect;
                YioRect lr2 = child.Geometry.LayoutRect;
        ...
        /// LocalToGlobal(YioVector2) 与 LocalToGlobal(YioRect) 一致性：LocalToGlobal(rect).Position == LocalToGlobal(rect.Position)。
        /// </summary>
        [Fact]
        public void GeometryLocalToGlobalRectConsistentWithPoint()
        {
            ...
            try
            {
                ...
                YioRect lr = child.Geometry.LayoutRect;
                YioRect world = child.Geometry.WorldRect;
                // WorldRect.Position 应等于 LocalToGlobal(LayoutRect.Position)。
                YioVector2 worldOrigin = child.Geometry.LocalToGlobal(new YioVector2(lr.X, lr.Y));
        ...
        public void GeometryLocalToGlobalRoundTrip()
        {
            ...
            try
            {
                ...
                var p = new YioVector2(123.4f, 567.8f);
                YioVector2 roundTrip = child.Geometry.GlobalToLocal(child.Geometry.LocalToGlobal(p));
        ...
        public void TransformSetterStoresMirrorNoFlush()
        {
            ...
            try
            {
                ...
                var pos = new YioVector2(10f, 20f);
        ...
        public void TransformAllPropsRoundTrip()
        {
            ...
            {
                Node n = ctx._registry.GetOrCreate(CreateRoot(stage, "div"));
                var pos = new YioVector2(1f, 2f);
                var scale = new YioVector2(3f, 4f);
                var origin = new YioVector2(5f, 6f);
                n.Transform.Position = pos;
        ...
        public void TransformReturnsSameInstance()
        {
            ...
            try
            {
                ...
                n.Transform.Position = new YioVector2(10f, 20f);
                n.Transform.Scale = new YioVector2(2f, 2f);
                Assert.Equal(new YioVector2(10f, 20f), n.Transform.Position);
                Assert.Equal(new YioVector2(2f, 2f), n.Transform.Scale);
            }
            finally
            {
                StageHarness.Destroy(stage);
        ...
        public void TransformUnwrittenReturnsDefaults()
        {
            ...
            {
                Node n = ctx._registry.GetOrCreate(CreateRoot(stage, "div"));
                Assert.Equal(YioVector2.Zero, n.Transform.Position);
                Assert.Equal(YioVector2.One, n.Transform.Scale);
                Assert.Equal(0f, n.Transform.Rotation);
                Assert.Equal(YioVector2.Zero, n.Transform.Origin);
            }
            finally
            {
                StageHarness.Destroy(stage);
        ...
        private static Node AppendChildDiv(IntPtr stage, UIContext ctx)
        {
            ...
            ulong child;
            fixed (byte* kp = k)
                child = Native.yio_stage_create_node(h, kp, (nuint)k.Length, null, 0);
            if (child == InvalidNodeId)
                throw new InvalidOperationException("create_node(div) failed");

            int rc = Native.yio_stage_append_child(h, root, child);
            if (rc != 0)
        ...
        private static void Tick(IntPtr stage, UIContext ctx)
        {
            ...
            Native.yio_stage_tick((StageHandle*)stage.ToPointer(), 0.016f);
        }
    }
}
