...
namespace LoomGUI
{
    ...
    /// (loom.runtime.json). Lists packages, atlases, and fonts the backend needs to load at startup.
    /// </summary>
    ...
    /// <summary>
    /// Incremental JSON reader for the two manifest formats (loom.runtime.json and atlas.json).
