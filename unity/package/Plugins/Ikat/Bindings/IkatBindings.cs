...
namespace Ikat.Bindings
{
    ...
    {
        const string __DllName = "ikat_ffi_c";



        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        internal delegate int ikat_register_clipboard_get_fn_delegate(byte** arg1, nuint* arg2);

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        internal delegate int ikat_register_clipboard_set_fn_delegate(byte* arg1, nuint arg2);
        ...
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_ffi_panic_count", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern uint ikat_ffi_panic_count();
        ...
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_version", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern byte* ikat_version();

        /// <summary>
        ///  创建 Stage 句柄（不收字体路径）。字体由 ikat_stage_register_font 单独注册。
        ///  失败返回 null（当前 Stage::new 不返回 Err，保留 null 分支以保持对称）。
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_new", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern StageHandle* ikat_stage_new(float w, float h);
        ...
        ///  **常驻（不 gate）。**
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_set_root_size", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_stage_set_root_size(StageHandle* h, float w, float hgt);
        ...
        ///  **常驻（不 gate）。**
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_compute_adaptation", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        ...
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_register_font", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_stage_register_font(StageHandle* h, byte* family, nuint family_len, byte* bytes, nuint bytes_len, byte is_default);
        ...
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_set_fallback_families", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_stage_set_fallback_families(StageHandle* h, byte* text, nuint text_len);

        /// <summary>
        ///  null-safe 释放 Stage 句柄。
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_free", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern void ikat_stage_free(StageHandle* h);
        ...
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_load_package", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_stage_load_package(StageHandle* h, byte* name, nuint name_len, byte* bytes, nuint bytes_len);
        ...
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_pkg_format_version", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern uint ikat_pkg_format_version();
        ...
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_unload_package", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_stage_unload_package(StageHandle* h, byte* name, nuint name_len);
        ...
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_instantiate", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern ulong ikat_stage_instantiate(StageHandle* h, byte* pkg, nuint pkg_len, byte* comp, nuint comp_len);
        ...
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_tick", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern void ikat_stage_tick(StageHandle* h, float dt);

        /// <summary>
        ///  借出最近一帧 blob：写 len 到 out_len，返回 Rust 拥有缓存指针（下 tick 失效）。
        ///  null 句柄或未 tick 过返回 null + len=0。
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_borrow_frame", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern byte* ikat_stage_borrow_frame(StageHandle* h, nuint* out_len);

        /// <summary>
        ///  dump 整树 JSON（调试）。返 Rust 拥有的 UTF-8 C 串 + len；下 tick 失效。
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_dump_scene", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern byte* ikat_stage_dump_scene(StageHandle* h, nuint* out_len);
        ...
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_take_warnings", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern byte* ikat_stage_take_warnings(StageHandle* h, nuint* out_len);
        ...
        ///  **测试 helper（不 gate）。**
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_make_test_pkg", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern byte* ikat_make_test_pkg(byte* comp, nuint comp_len, nuint* out_len);
        ...
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_take_missing_glyphs", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern byte* ikat_stage_take_missing_glyphs(StageHandle* h, nuint* out_len);

        /// <summary>
        ///  释放 ikat_make_test_pkg 返回的 bytes。
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_bytes_free", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern void ikat_bytes_free(byte* ptr, nuint len);
        ...
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_dump_tree", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern byte* ikat_stage_dump_tree(StageHandle* h, byte* filter, nuint filter_len, nuint* out_len);
        ...
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_set_input", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern void ikat_stage_set_input(StageHandle* h, PointerEvent* events, nuint len);
        ...
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_borrow_events", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern byte* ikat_stage_borrow_events(StageHandle* h, nuint* out_len);
        ...
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_get_event_string", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_stage_get_event_string(StageHandle* h, uint idx, byte* @out, nuint buf_cap, nuint* out_len);
        ...
        ///  **常驻（不 gate）。**
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_is_pointer_on_ui", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.U1)]
        internal static extern bool ikat_stage_is_pointer_on_ui(StageHandle* h);
        ...
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_cursor_query", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern uint ikat_stage_cursor_query(StageHandle* h);
        ...
        ///  **常驻（不 gate）：**runtime 稳定入口。
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_add_touch_monitor", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern void ikat_stage_add_touch_monitor(StageHandle* h, int touch_id, ulong node_id);
        ...
        ///  **常驻（不 gate）。**
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_remove_touch_monitor", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern void ikat_stage_remove_touch_monitor(StageHandle* h, ulong node_id);

        /// <summary>
        ///  外部取消待 click（照 fgui Stage.CancelClick(touchId)）。置对应槽 click_cancelled。
        ///  null 句柄 → no-op。
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_cancel_click", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern void ikat_stage_cancel_click(StageHandle* h, int touch_id);
        ...
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_set_key_input", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern void ikat_stage_set_key_input(StageHandle* h, KeyEvent* keys, nuint len);
        ...
        ///  **常驻（不 gate）。**
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_register_clipboard", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern void ikat_register_clipboard(ikat_register_clipboard_set_fn_delegate set_fn, ikat_register_clipboard_get_fn_delegate get_fn);
        ...
        ///  **常驻（不 gate）：**输入是 runtime 稳定入口。
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_set_wheel_input", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern void ikat_stage_set_wheel_input(StageHandle* h, WheelEvent* events, nuint len);
        ...
        ///  **常驻（不 gate）。**
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_request_focus", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern void ikat_stage_request_focus(StageHandle* h, ulong node_id);
        ...
        ///  **常驻（不 gate）。**
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_focused_node", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern ulong ikat_stage_focused_node(StageHandle* h);
        ...
        ///  **常驻（不 gate）。**
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_blur", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_stage_blur(StageHandle* h);
        ...
        ///  **常驻（不 gate）。**
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_hit_test", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_stage_hit_test(StageHandle* h, float x, float y, ulong* out_node);
        ...
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_hit_test_rich", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.U1)]
        internal static extern bool ikat_hit_test_rich(StageHandle* h, ulong node_id, float x, float y, ulong* out_source);
        ...
        ///  **常驻（不 gate）。**
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_get_node_focusable", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_stage_get_node_focusable(StageHandle* h, ulong node_id, byte* @out);
        ...
        ///  **常驻（不 gate）。**
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_get_node_touchable", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        ...
        ///  **常驻（不 gate）。**
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_node_is_lookup_scope", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_node_is_lookup_scope(StageHandle* h, ulong node_id);
        ...
        ///  **常驻（不 gate）。**
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_get_custom_tag", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_stage_get_custom_tag(StageHandle* h, ulong node_id, byte* @out, nuint buf_cap, nuint* out_len);
        ...
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_node_parent", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern ulong ikat_node_parent(StageHandle* h, ulong node_id);
        ...
        ///  **常驻（不 gate）：**runtime 稳定入口，`--no-default-features` 构建的 .dll 仍有本函数。
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_find_node_by_id", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern ulong ikat_stage_find_node_by_id(StageHandle* h, byte* id, nuint id_len);
        ...
        ///  **常驻（不 gate）：**runtime 稳定入口。
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_find_node_by_id_in_subtree", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern ulong ikat_stage_find_node_by_id_in_subtree(StageHandle* h, ulong root, byte* id, nuint id_len);

        /// <summary>
        ///  读节点 layout_rect。null 句柄/无效 node → out 填 0（不 panic）。
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_get_node_layout_rect", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern void ikat_stage_get_node_layout_rect(StageHandle* h, ulong node_id, float* out_x, float* out_y, float* out_w, float* out_h);
        ...
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_get_node_world_matrix", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern void ikat_stage_get_node_world_matrix(StageHandle* h, ulong node_id, float* out_a, float* out_b, float* out_c, float* out_d, float* out_tx, float* out_ty);

        /// <summary>
        ///  读节点 sort_key（merge 前快照，DFS 序号）。null/无效 → 写 0。
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_get_node_sort_key", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern void ikat_stage_get_node_sort_key(StageHandle* h, ulong node_id, uint* @out);

        /// <summary>
        ///  读节点可见性（存在 + 非 display:none）。null/无效 → 写 0（false）。
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_get_node_visible", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern void ikat_stage_get_node_visible(StageHandle* h, ulong node_id, byte* @out);
        ...
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_get_node_kind", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_stage_get_node_kind(StageHandle* h, ulong node_id, byte* @out);
        ...
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_get_node_id_attr", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        ...
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_get_link_href", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_stage_get_link_href(StageHandle* h, ulong node_id, byte* @out, nuint buf_cap, nuint* out_len);
        ...
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_get_node_opacity", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_stage_get_node_opacity(StageHandle* h, ulong node_id, float* @out);
        ...
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_get_node_classes", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_stage_get_node_classes(StageHandle* h, ulong node_id, byte* @out, nuint buf_cap, nuint* out_len);

        /// <summary>
        ///  读节点 computed style 快照。return code：0 = ok 且 `*out` 填好；非 0 = 失败（节点不存在
        ///  或 `out` = null）。
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_get_node_computed_style", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_stage_get_node_computed_style(StageHandle* h, ulong node_id, ComputedNodeStyleRepr* @out);
        ...
        ///  **常驻（不 gate）。**
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_get_child_count", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_stage_get_child_count(StageHandle* h, ulong node);
        ...
        ///  **常驻（不 gate）。**
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_get_children", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_stage_get_children(StageHandle* h, ulong node, ulong* @out, nuint cap);
        ...
        ///  **常驻（不 gate）。**
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_get_node_disabled", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        ...
        ///  **常驻（不 gate）。**
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_set_node_disabled", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern void ikat_stage_set_node_disabled(StageHandle* h, ulong node_id, [MarshalAs(UnmanagedType.U1)] bool disabled);
        ...
        ///  **常驻（不 gate）。**
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_set_node_focusable", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern void ikat_stage_set_node_focusable(StageHandle* h, ulong node_id, [MarshalAs(UnmanagedType.U1)] bool focusable);

        /// <summary>
        ///  设渲染复用键（虚拟列表 slot）。null 句柄/无效 node → no-op。
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_set_reuse_key", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern void ikat_stage_set_reuse_key(StageHandle* h, ulong node_id, uint key);

        /// <summary>
        ///  克隆场景内子树（游离根，不挂树）。返回新 node_id；u64::MAX = err / null 句柄 / 无效 src。
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_clone_subtree", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern ulong ikat_stage_clone_subtree(StageHandle* h, ulong src);
        ...
        ///  **常驻（不 gate）：**runtime 稳定入口，`--no-default-features` 构建的 .dll 仍有本函数。
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_create_root", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern ulong ikat_stage_create_root(StageHandle* h, byte* kind, nuint kind_len, byte* css, nuint css_len);
        ...
        ///  **常驻（不 gate）。**
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_create_node", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern ulong ikat_stage_create_node(StageHandle* h, byte* kind, nuint kind_len, byte* css, nuint css_len);
        ...
        ///  **常驻（不 gate）。**
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_append_child", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_stage_append_child(StageHandle* h, ulong parent, ulong child);
        ...
        ///  **常驻（不 gate）。**
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_insert_before", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_stage_insert_before(StageHandle* h, ulong parent, ulong child, ulong ref_id);
        ...
        ///  **常驻（不 gate）。**
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_remove_child", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_stage_remove_child(StageHandle* h, ulong parent, ulong child);
        ...
        ///  **常驻（不 gate）。**
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_remove_node", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_stage_remove_node(StageHandle* h, ulong node);
        ...
        ///  **常驻（不 gate）。**
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_set_text", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_stage_set_text(StageHandle* h, ulong node, byte* text, nuint len);
        ...
        ///  **常驻（不 gate）。**
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_restart_animations", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_stage_restart_animations(StageHandle* h, ulong node_id);
        ...
        ///  **常驻（不 gate）。**
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_set_src", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_stage_set_src(StageHandle* h, ulong node, byte* src, nuint len);
        ...
        ///  **常驻（不 gate）。**
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_set_inline_override", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_stage_set_inline_override(StageHandle* h, ulong node, byte* css, nuint len);
        ...
        ///  **常驻（不 gate）。**
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_unset_inline_override", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_stage_unset_inline_override(StageHandle* h, ulong node, byte* prop, nuint len);
        ...
        ///  **常驻（不 gate）。**
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_add_class", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_stage_add_class(StageHandle* h, ulong node, byte* name, nuint len);
        ...
        ///  **常驻（不 gate）。**
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_remove_class", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_stage_remove_class(StageHandle* h, ulong node, byte* name, nuint len);
        ...
        ///  **常驻（不 gate）。**
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_has_class", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_stage_has_class(StageHandle* h, ulong node, byte* name, nuint len);
        ...
        ///  **常驻（不 gate）。**
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_set_transform", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        ...
        ///  **常驻（不 gate）。**
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_set_control_value", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_stage_set_control_value(StageHandle* h, ulong node_id, float value);
        ...
        ///  **常驻（不 gate）。**
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_get_control_value", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_stage_get_control_value(StageHandle* h, ulong node_id, float* @out);
        ...
        ///  **常驻（不 gate）。**
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_set_control_checked", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_stage_set_control_checked(StageHandle* h, ulong node_id, [MarshalAs(UnmanagedType.U1)] bool @checked);
        ...
        ///  **常驻（不 gate）。**
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_get_control_checked", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_stage_get_control_checked(StageHandle* h, ulong node_id, bool* @out);
        ...
        ///  **常驻（不 gate）。**
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_set_control_max", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_stage_set_control_max(StageHandle* h, ulong node_id, float max);
        ...
        ///  **常驻（不 gate）。**
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_get_control_max", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        ...
        ///  **常驻（不 gate）。**
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_set_control_min", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        ...
        ///  **常驻（不 gate）。**
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_get_control_min", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_stage_get_control_min(StageHandle* h, ulong node_id, float* @out);
        ...
        ///  **常驻（不 gate）。**
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_set_control_step", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_stage_set_control_step(StageHandle* h, ulong node_id, float step);
        ...
        ///  **常驻（不 gate）。**
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_get_control_step", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_stage_get_control_step(StageHandle* h, ulong node_id, float* @out);
        ...
        ///  **常驻（不 gate）。**
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_get_control_indeterminate", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_stage_get_control_indeterminate(StageHandle* h, ulong node_id, byte* @out);
        ...
        ///  **常驻（不 gate）。**
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_set_control_indeterminate", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_stage_set_control_indeterminate(StageHandle* h, ulong node_id, byte v);
        ...
        ///  **常驻（不 gate）。**
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_get_radio_name", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_stage_get_radio_name(StageHandle* h, ulong node_id, byte* @out, nuint buf_cap, nuint* out_len);
        ...
        ///  **常驻（不 gate）。**
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_get_dropdown_selected_value", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_stage_get_dropdown_selected_value(StageHandle* h, ulong node_id, byte* @out, nuint buf_cap, nuint* out_len);
        ...
        ///  **常驻（不 gate）。**
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_get_option_value", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_stage_get_option_value(StageHandle* h, ulong node_id, byte* @out, nuint buf_cap, nuint* out_len);
        ...
        ///  **常驻（不 gate）。**
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_is_option_selected", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_stage_is_option_selected(StageHandle* h, ulong node_id);
        ...
        ///  **常驻（不 gate）。**
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_get_option_index", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_stage_get_option_index(StageHandle* h, ulong node_id);
        ...
        ///  **常驻（不 gate）。**
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_is_tab_selected", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_stage_is_tab_selected(StageHandle* h, ulong node_id);
        ...
        ///  **常驻（不 gate）。**
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_get_dropdown_selected_index", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_stage_get_dropdown_selected_index(StageHandle* h, ulong node_id, uint* @out);
        ...
        ///  **常驻（不 gate）。**
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_set_dropdown_selected_index", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_stage_set_dropdown_selected_index(StageHandle* h, ulong node_id, uint index);
        ...
        ///  **常驻（不 gate）。**
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_get_tablist_selected_index", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_stage_get_tablist_selected_index(StageHandle* h, ulong node_id, uint* @out);
        ...
        ///  **常驻（不 gate）。**
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_set_tablist_selected_index", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_stage_set_tablist_selected_index(StageHandle* h, ulong node_id, uint index);
        ...
        ///  **常驻（不 gate）。**
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_get_dropdown_open", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_stage_get_dropdown_open(StageHandle* h, ulong node_id, byte* @out);
        ...
        ///  **常驻（不 gate）。**
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_set_dropdown_open", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_stage_set_dropdown_open(StageHandle* h, ulong node_id, byte open);
        ...
        ///  **常驻（不 gate）。**
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_get_number_value", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_stage_get_number_value(StageHandle* h, ulong node_id, float* @out);
        ...
        ///  **常驻（不 gate）：**输入是 runtime 稳定入口。
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_set_text_input", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_stage_set_text_input(StageHandle* h, uint* codepoints, nuint len);
        ...
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_set_composition", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_stage_set_composition(StageHandle* h, ulong node, byte* text, nuint text_len, nuint pos);
        ...
        ///  **常驻（不 gate）。**
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_commit_composition", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_stage_commit_composition(StageHandle* h, ulong node);
        ...
        ///  **常驻（不 gate）。**
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_get_cursor_rect", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_stage_get_cursor_rect(StageHandle* h, ulong node, CursorRectRepr* @out);
        ...
        ///  **常驻（不 gate）。**
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_set_control_text", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_stage_set_control_text(StageHandle* h, ulong node_id, byte* text, nuint len);
        ...
        ///  **常驻（不 gate）。**
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_get_control_text", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_stage_get_control_text(StageHandle* h, ulong node_id, byte* @out, nuint buf_cap, nuint* out_len);
        ...
        ///  **常驻（不 gate）。**
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_set_selection", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_stage_set_selection(StageHandle* h, ulong node_id, nuint anchor, nuint cursor);
        ...
        ///  **常驻（不 gate）。**
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_get_selection", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_stage_get_selection(StageHandle* h, ulong node_id, nuint* start, nuint* end);
        ...
        ///  **常驻（不 gate）。**
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_set_control_placeholder", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_stage_set_control_placeholder(StageHandle* h, ulong node_id, byte* text, nuint len);
        ...
        ///  **常驻（不 gate）。**
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_get_control_placeholder", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_stage_get_control_placeholder(StageHandle* h, ulong node_id, byte* @out, nuint buf_cap, nuint* out_len);
        ...
        ///  **常驻（不 gate）。**
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_set_control_readonly", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_stage_set_control_readonly(StageHandle* h, ulong node_id, [MarshalAs(UnmanagedType.U1)] bool @readonly);
        ...
        ///  **常驻（不 gate）。**
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_set_control_maxlength", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_stage_set_control_maxlength(StageHandle* h, ulong node_id, nuint max_length);
        ...
        ///  **常驻（不 gate）。**
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_get_control_maxlength", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_stage_get_control_maxlength(StageHandle* h, ulong node_id, nuint* @out);
        ...
        ///  **常驻（不 gate）。**
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_get_control_readonly", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_stage_get_control_readonly(StageHandle* h, ulong node_id, byte* @out);
        ...
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_measure_text", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_stage_measure_text(StageHandle* h, byte* text, nuint text_len, byte* family, nuint family_len, float size_px, float max_width, float* out_w, float* out_h, uint* out_lines);

        /// <summary>
        ///  编程滚动到指定位置。非 scroll 容器 / 越界 node → no-op（不 panic）。
        ///  animated: u8（0=瞬移 1=缓动 cubic-out）。null 句柄 → no-op。
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_set_scroll_pos", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern void ikat_stage_set_scroll_pos(StageHandle* h, ulong node_id, float x, float y, byte animated);

        /// <summary>
        ///  driver 注入滚动容器 content_size（虚拟列表）。node 无效/非滚动容器 → no-op。
        ///  null 句柄 → no-op（不 panic）。
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_set_content_size", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern void ikat_stage_set_content_size(StageHandle* h, ulong node_id, float w, float height);

        /// <summary>
        ///  清除 driver 注入的 content_size override（列表销毁/退回普通滚动时用）。
        ///  null 句柄/无效 node → no-op（不 panic）。
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_clear_content_size_override", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern void ikat_stage_clear_content_size_override(StageHandle* h, ulong node_id);

        /// <summary>
        ///  读 scroll_pos。null 句柄/无效 node → out 填 0（不 panic）。
        ///  out_x/out_y 是 out 参数（C# 传 ref float）。
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_get_scroll_pos", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern void ikat_stage_get_scroll_pos(StageHandle* h, ulong node_id, float* out_x, float* out_y);
        ...
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_tween_spec", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern void ikat_stage_tween_spec(StageHandle* h, ulong node_id, IkatTweenSpec* spec, float* start, float* end);
        ...
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_tween_shadow", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern void ikat_stage_tween_shadow(StageHandle* h, ulong node_id, IkatTweenSpec* spec, float* start, uint start_layers, float* end, uint end_layers);

        /// <summary>
        ///  停该节点该 prop 的 tween（override 保留末值）。
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_kill_tween", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern void ikat_stage_kill_tween(StageHandle* h, ulong node_id, uint prop);

        /// <summary>
        ///  清该节点所有动画 override（回 CSS）。
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_clear_anim", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern void ikat_stage_clear_anim(StageHandle* h, ulong node_id);

        /// <summary>
        ///  清该节点某 prop 对应通道（回 CSS）。
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_clear_anim_prop", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern void ikat_stage_clear_anim_prop(StageHandle* h, ulong node_id, uint prop);
        ...
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_play_animation", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern ulong ikat_stage_play_animation(StageHandle* h, ulong node, byte* name, nuint name_len);
        ...
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_play_animation_dur", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern ulong ikat_stage_play_animation_dur(StageHandle* h, ulong node, byte* name, nuint name_len, float duration_s);

        /// <summary>
        ///  暂停 player（Playing → Paused，elapsed 冻结位置保持）。key 无效 / 非 Playing → no-op。
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_pause_animation", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern void ikat_stage_pause_animation(StageHandle* h, ulong key);

        /// <summary>
        ///  恢复播放（Paused → Playing）。key 无效 / 非 Paused → no-op
        ///  （Completed 是粘性完成态、Stopped 是终态，均不可恢复）。
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_resume_animation", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern void ikat_stage_resume_animation(StageHandle* h, ulong key);
        ...
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_stop_animation", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern void ikat_stage_stop_animation(StageHandle* h, ulong key);

        /// <summary>
        ///  读 player 时间轴位置（elapsed——含 delay 计时的唯一时间源头，spec §5.3）。
        ///  key 无效 / 无 scene → 0.0（不 panic）。
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_get_animation_time", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern float ikat_stage_get_animation_time(StageHandle* h, ulong key);

        /// <summary>
        ///  seek：设 player.elapsed，下一帧 step b 按新位置采样（C# `Animation.Time` setter）。
        ///  时间源头单一是 elapsed，不校验范围（负值 = 仍在 delay 阶段之前）。key 无效 → no-op。
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_set_animation_time", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern void ikat_stage_set_animation_time(StageHandle* h, ulong key, float time);

        /// <summary>
        ///  读 player 运行状态。Playing=0 / Paused=1 / Completed=2；Invalid=255（key 不存在 /
        ///  无 scene / Stopped——Stopped 是终态，下帧即回收，语义等同无效）。
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_get_animation_state", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern byte ikat_stage_get_animation_state(StageHandle* h, ulong key);
        ...
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_animation_on_key", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern void ikat_stage_animation_on_key(StageHandle* h, ulong key, float pct);
        ...
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_list_set_item_count", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        ...
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_list_take_pending_binds", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_list_take_pending_binds(StageHandle* h, ulong* out_nodes, int* out_indices, uint cap, uint* out_len);
        ...
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_list_drain_now", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_list_drain_now(StageHandle* h, ulong node);
        ...
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_list_refresh", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_list_refresh(StageHandle* h, ulong node, int start, int count);
        ...
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_list_notify", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_list_notify(StageHandle* h, ulong node, byte op, int a, int b);
        ...
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_list_scroll_to", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern int ikat_list_scroll_to(StageHandle* h, ulong node, int index, byte behavior);
        ...
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_set_image_sizes", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern void ikat_stage_set_image_sizes(StageHandle* h, byte** paths_ptr, uint* ws, uint* hs, nuint count);

        /// <summary>
        ///  拉脏页 page_idx 列表（写入 out，返实际数）。null 句柄 / null out → 返 0。
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_font_atlas_dirty_pages", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern nuint ikat_stage_font_atlas_dirty_pages(StageHandle* h, uint* @out, nuint max);

        /// <summary>
        ///  读某页 R8 像素 + 尺寸。buf_len 不够返所需大小（双调法：先传小 buf 探大小）。
        ///  无此页 / null 句柄 / null out_buf → 返 0。
        /// </summary>
        [DllImport(__DllName, EntryPoint = "ikat_stage_font_atlas_page", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern nuint ikat_stage_font_atlas_page(StageHandle* h, uint page, uint* out_w, uint* out_h, byte* out_buf, nuint buf_len);
    ...
    /// </summary>
    [StructLayout(LayoutKind.Sequential)]
    internal unsafe partial struct IkatTweenSpec
    {
        public uint prop;
