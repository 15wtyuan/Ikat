...
- ✅ **keyframes runtime 驱动 + fence 动画子集 — RESOLVED（功能层）**（M2 @keyframes runtime，2026-08）：M2 交付功能完整的动画系统（spec `docs/superpowers/specs/2026-08-04-m2-keyframes-runtime-design.md`，plan `docs/superpowers/plans/2026-08-04-m2-keyframes-runtime.md`，branch `m2-keyframes`）。原列缺口状态：
