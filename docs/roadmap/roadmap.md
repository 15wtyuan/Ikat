...
> **状态：Spec-4a spec/plan 完成（2026-07-17），进入实现**。spec `docs/superpowers/specs/2026-07-17-spec4a-projection-layer-design.md`、plan `docs/superpowers/plans/2026-07-17-spec4a-projection-layer.md`、branch `spec4a-projection-layer`。
>
