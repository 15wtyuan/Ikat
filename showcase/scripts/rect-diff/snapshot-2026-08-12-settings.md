...
| letterbox 修复普适性 | 留 Task 4 全量验证 | reset.css / browser-rect 改的是全局共享的 preview-base.css + loom-preview.js，对 home/inventory 等同样生效（.root 都恢复 1920×1080）。settings 已确认 .root=1920×1080@0,0；其余 7 页待 Task 4 全量验证。 |
