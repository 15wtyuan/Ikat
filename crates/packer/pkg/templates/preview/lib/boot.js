// 预览 A 层引导（框架真相副本，嵌在 yio 二进制里；server 对每个 HTML 页自动注入
...
//
// 工作区脚本用 `import { ready } from '/yio-preview/lib/boot.js'` 等待 A 层
...
function injectBaseCss() {
  ...
  // data-yio-preview 标「框架自有」：expand.js 的组件样式链接按「页面自有
  // style/link 之前」定位插入点，靠它把 base.css 与组件链接排除在锚点外。
  const link = document.createElement('link');
  link.rel = 'stylesheet';
  link.setAttribute('data-yio-preview', 'base');
  link.href = '/yio-preview/lib/base.css';
