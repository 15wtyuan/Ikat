...
fn smoke_control_kinds_load_without_crash() {
    ...
    let html = r#"<!DOCTYPE html><html><head></head><body><div style="display:flex"><input type="text"><input type="range"><input type="checkbox"><input type="radio"><select><option></option></select></div></body></html>"#;
