...
use yio_core::scene::node::ControlState;
...
#[no_mangle]
pub extern "C" fn yio_stage_set_text_input(
    h: *mut StageHandle,
...
#[no_mangle]
pub extern "C" fn yio_stage_set_composition(
    h: *mut StageHandle,
    node: u64,
    text: *const u8,
    text_len: usize,
...
/// **常驻（不 gate）。**
#[no_mangle]
pub extern "C" fn yio_stage_commit_composition(h: *mut StageHandle, node: u64) -> i32 {
    ffi_guard(-1, || {
        if h.is_null() {
            return -1;
        }
...
/// **常驻（不 gate）。**
#[no_mangle]
pub extern "C" fn yio_stage_get_cursor_rect(
    h: *const StageHandle,
    node: u64,
...
/// **常驻（不 gate）。**
#[no_mangle]
pub extern "C" fn yio_stage_set_control_text(
    h: *mut StageHandle,
    node_id: u64,
    text: *const u8,
    len: usize,
    ...
    ffi_guard(-1, || {
        ...
        if changed {
            yio_core::scene::control::emit_value_changed(&mut sh.stage.pending_events, id);
        }
        0
    })
}
...
/// **常驻（不 gate）。**
#[no_mangle]
pub extern "C" fn yio_stage_get_control_text(
    h: *const StageHandle,
    node_id: u64,
    out: *mut u8,
    buf_cap: usize,
...
/// **常驻（不 gate）。**
#[no_mangle]
pub extern "C" fn yio_stage_set_selection(
    h: *mut StageHandle,
    node_id: u64,
    anchor: usize,
    cursor: usize,
...
/// **常驻（不 gate）。**
#[no_mangle]
pub extern "C" fn yio_stage_get_selection(
    h: *const StageHandle,
    node_id: u64,
    start: *mut usize,
    end: *mut usize,
...
/// **常驻（不 gate）。**
#[no_mangle]
pub extern "C" fn yio_stage_set_control_placeholder(
    h: *mut StageHandle,
    node_id: u64,
    text: *const u8,
    len: usize,
...
/// **常驻（不 gate）。**
#[no_mangle]
pub extern "C" fn yio_stage_get_control_placeholder(
    h: *const StageHandle,
    node_id: u64,
    out: *mut u8,
    buf_cap: usize,
...
/// **常驻（不 gate）。**
#[no_mangle]
pub extern "C" fn yio_stage_set_control_readonly(
    h: *mut StageHandle,
    node_id: u64,
    readonly: bool,
) -> i32 {
...
/// **常驻（不 gate）。**
#[no_mangle]
pub extern "C" fn yio_stage_set_control_maxlength(
    h: *mut StageHandle,
    node_id: u64,
    max_length: usize,
) -> i32 {
...
/// **常驻（不 gate）。**
#[no_mangle]
pub extern "C" fn yio_stage_get_control_maxlength(
    h: *const StageHandle,
    node_id: u64,
    out: *mut usize,
) -> i32 {
...
/// **常驻（不 gate）。**
#[no_mangle]
pub extern "C" fn yio_stage_get_control_readonly(
    h: *const StageHandle,
    node_id: u64,
    out: *mut u8,
) -> i32 {
...
#[no_mangle]
pub extern "C" fn yio_stage_measure_text(
    h: *mut StageHandle,
    text: *const u8,
    text_len: usize,
    family: *const u8,
    ...
    ffi_guard(-1, || {
        ...
        match sh.stage.measure_text(text, family, size_px, max_width) {
            ...
            Err(yio_core::stage::MeasureTextError::UnknownFamily(_)) => -2,
            Err(yio_core::stage::MeasureTextError::InvalidParams(_)) => -3,
        }
    })
}
