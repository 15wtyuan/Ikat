...
use yio_core::render::build_render_nodes;
use yio_core::scene::node::{Node, NodeId, NodeKind, Rect, Scene};
use yio_core::scene::transform::compute_world_transforms;
use yio_core::text::atlas::GlyphAtlas;
...
fn frame(scene: &mut Scene) -> yio_core::render::FrameData {
...
fn assert_all_alphas(frame: &yio_core::render::FrameData, ids: &[u64], expected: f32, msg: &str) {
